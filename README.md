...
| `poisoned_script.py`         | Generates poisoned logs and saves the poisoned+benign logs in benign.json   |
...
via:
   ```bash
   # Setting-up the configuration file for logstash using "minio-to-es.conf" file
